...
exports.default = {
    ...
    methods: {
        dismissMessage: function dismissMessage(message) {
            this.list.$remove(message);
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"alert alert-{{ message.type }} alert-dismissible\" role=\"alert\" v-for=\"message in list\">\n    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\" @click=\"dismissMessage(message)\">\n        <span aria-hidden=\"true\">×</span>\n    </button>\n    {{ message.body }}\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/nickdenardis/Sites/valet/todo/resources/assets/js/components/Alerts.vue"
...
},{"vue":42,"vue-hot-reload-api":39,"vueify-insert-css":43}],45:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n")
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/nickdenardis/Sites/valet/todo/resources/assets/js/components/Paging.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":42,"vue-hot-reload-api":39,"vueify-insert-css":43}],46:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        ...
        editTask: function editTask(task) {
            ...
            this._beforeEditingCache = (0, _assign2.default)({}, task);
        ...
        doneEdit: function doneEdit(task) {
            ...
            this.resource.update({ id: task.id }, { body: task.body }).then(function (response) {
                ...
                (0, _assign2.default)(task, this._beforeEditingCache);
...
},{"babel-runtime/core-js/object/assign":1,"vue":42,"vue-hot-reload-api":39,"vueify-insert-css":43}],47:[function(require,module,exports){
'use strict';
...
var _Paging = require('./components/Paging.vue');
...
var alert_store = [];
var task_store = [];
var sites_store = [{ name: 'John', age: 50 }, { name: 'Jack', age: 35 }, { name: 'Keith', age: 28 }, { name: 'Alain', age: 17 }, { name: 'Neil', age: 1 }, { name: 'Mark', age: 72 }, { name: 'Don', age: 47 }, { name: 'Walter', age: 41 }, { name: 'Jessy', age: 33 }, { name: 'Henck', age: 22 }, { name: 'Sal', age: 9 }, { name: 'Skyler', age: 42 }, { name: 'Holly', age: 55 }];
...
new _Vue2.default({
    ...
    components: {
        Alerts: _Alerts2.default, Todo: _Todo2.default, Paging: _Paging2.default
    },

    // Action to perform globally, outsite of the components
    methods: {
        showAlert: function showAlert(message, type, clear) {
    ...
    events: {
        'new-task': function newTask(message) {
            this.showAlert('New todo item added: "' + message + '"', 'info');
        },
        'cleared-completed': function clearedCompleted(count) {
            this.showAlert(count + ' items cleared', 'info', true);
        },
        'error-alert': function errorAlert(text) {
            this.showAlert(text, 'danger', true);
        }
    }
});

},{"./components/Alerts.vue":44,"./components/Paging.vue":45,"./components/Todo.vue":46,"Vue":42,"vue-resource":40,"vue-router":41}]},{},[47]);
